...
a `_brain/` with memory-type folders (knowledge, skills, journals by day, vision, plans, conventions) plus the brain's own to-do queue and raw source material, a slow half-life the agent may steepen, a
